...
<body>
	...
	<form method="post" name="journeyform" onsubmit="return validate()">
		<select id="trains" name="trains" required>
			...
			<option value="Subarna Express" >Subarna Express - Chittagong to Dhaka 9.00AM</option>
			<option value="Mohanagar Goduli" >Mohanagar Goduli - Dhaka to Chittagong 08.00PM</option>
			<option value="Tista Express">Tista Express - Dhaka to Dewangonj 12.00AM</option>
			<option value="Parabat  Express" >Parabat  Express - Dhaka to Sylhet 05.00AM</option>
			<option value="Parabat  Express" >Parabat  Express - Dewangonj to Dhaka 11.00AM</option>
		</select>
		<br/><br/>
